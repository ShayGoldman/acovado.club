...
Plans:
- [ ] 01-01-PLAN.md — Reset modules/db: delete models/ and migrations/, clear schema.ts and seed.ts, update barrel export
- [ ] 01-02-PLAN.md — Point fixes: delete reset-reddit-data.ts, await producer.send(), replace E2E stub with test.todo
